...
var metaPngPkg = require('meta-png');
...
var metaPngPkg__default = /*#__PURE__*/_interopDefaultLegacy(metaPngPkg);
...
const generateScreenshotPath = ({
  ...
  const screenshotPath = path__default["default"].join(...imagesPath.split("/").map(parsePathPartVariables.bind(void 0, specPath)), sanitizeFilename(titleFromOptions));
