...
describe("Compare Transaction History Table - App1 vs App2", () => {
  it("should capture and compare transaction tables only", () => {
    ...
    cy.get('body > div:nth-child(10) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > label:nth-child(1) > span:nth-child(2)').click()
    cy.get(".ant-spin-dot").should("not.exist");
    cy.wait(5000);
      ...
      .then((app1Html) => {
        ...
        cy.origin(
          ...
          ({ userName, password }) => {
            ...
            //Apply transaction type filter
            cy.get('th:nth-child(3) div:nth-child(1) span:nth-child(2)').click();
            cy.get('body > div:nth-child(10) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > label:nth-child(1) > span:nth-child(2)').click().click()
            cy.get(".ant-spin-dot").should("not.exist");
            cy.wait(5000);
