...
describe('Batch Payments',function(){
    ...
    //SINGAPORE with USD
    //push fund
    it.only('TC_BP_119 - Add 2 recipients(individual) from the "Add Recipient" page with country = SINGAPORE and currency = USD. After adding, make a batch payment to these recipients using GBP and push funds.', function(){
        signin.Login(userName, password)
        newRecipient.goToPaymentsDashborad()
        newRecipient.gotoRecipientList()
        let email = batchPayments.generateRandomString(5)+ '@yopmail.com'
    ...
    it.only('TC_BP_120 - Add 2 recipients(business) from the "Add Recipient" page with country = SINGAPORE and currency = USD. After adding, make a batch payment to these recipients using GBP and push funds.', function(){
        signin.Login(userName, password)
        newRecipient.goToPaymentsDashborad()
        newRecipient.gotoRecipientList()
        let email = batchPayments.generateRandomString(5)+ '@yopmail.com'
